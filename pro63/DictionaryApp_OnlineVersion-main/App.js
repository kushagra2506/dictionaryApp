  ...
  render(){
    return (
      <View>
        ...
        <View>
          <Text> Word : {''} </Text>
          <Text style = {{fontSize : '18px'}}> {this.state.enteredText} </Text>
        </View>

        <View>
          <Text> Type : {''} </Text>
          <Text style = {{fontSize : '18px'}}> {this.state.lexicalCategory} </Text>
        </View>

        <View>
          <Text> Definition : {''} </Text>
          <Text style = {{fontSize : '18px'}}> {this.state.definition} </Text>
        </View>
      </View> 
    );
  }
